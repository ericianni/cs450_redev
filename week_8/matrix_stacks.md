...
If you can't figure it out after 10-20 minutes, you can "cheat" and look below.
...
modelStack.push(modelStack.top()); 
{
    ...
    sun.draw(modelStack.top(), view, proj, light, static_cast<float>(currentTime));
        ...
        { 
            ...
            earth.resetTransform();
            earth.rotate(earthSpin, glm::vec3(0.0f, 1.0f, 0.0f)); // Stays local to earth object!
            earth.draw(modelStack.top(), view, proj, light, static_cast<float>(currentTime));
            ...
            modelStack.push(modelStack.top()); {
                ...
                moon.draw(modelStack.top(), view, proj, light, static_cast<float>(currentTime));
